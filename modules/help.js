...
const embeds = [
    new EmbedBuilder()
        ...
        .setColor(0x5865F2)
        .setDescription(
            'Welcome to the Quest of the Learned Scholar, Adventurer! This application is designed to reward you for engaging in scholarly work, while also balancing your health and wellbeing. This file will tell you a bit about the app and the seven commands that are used to play the DungeonBard quest.'
        )
    ,
    new EmbedBuilder()
