...
INSERT INTO relic VALUES('Initiate4',0.75,'Medal of Scholarly Growth','Recognizes the scholar’s progress!',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('Collegiate1',0.5,'Notebook of Infinite Recall','Improves memory for exams!',100,'Soldier',1,NULL);
INSERT INTO relic VALUES('Collegiate2',0.5,'Annotated Tome of Clarity','Writing becomes a breeze!',2,'Soldier',604800,NULL);
INSERT INTO relic VALUES('Collegiate3',0.5,'Coffee Chalice of Wakefulness','Late-night study sessions give genius ideas!',2,'Artisan',604800,NULL);
INSERT INTO relic VALUES('Collegiate4',0.75,'Degree Scroll of Triumph','Ensures lasting academic renown!',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('Pedagogue1',0.5,'Teacher''s Tome of Tactics','Improves retention of pedagogical strategies for in-class application.',100,'Soldier',1,NULL);
INSERT INTO relic VALUES('Pedagogue2',0.5,'Communicator''s Compendium','Elevates the precision and conciseness of professional correspondence and feedback.',2,'Soldier',604800,NULL);
INSERT INTO relic VALUES('Pedagogue3',0.5,'Chalice of Classroom Command','Bestows a commanding presence and the energy to manage a full day of lessons.',2,'Artisan',604800,NULL);
INSERT INTO relic VALUES('Pedagogue4',0.75,'Guiding Scroll of Wisdom','Confers an enduring reputation for excellence in instructional practice and leadership.',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('Masters1',0.5,'Tome of Infinite Footnotes','Citation tasks are a breeze!',100,'Soldier',1,NULL);
INSERT INTO relic VALUES('Masters2',0.5,'Philosopher’s Flask','The next late-night writing session is flawless!',2,'Soldier',604800,NULL);
INSERT INTO relic VALUES('Masters3',0.5,'Quill of Perfect Clarity','Future thesis revisions are twice as efficient!',2,'Artisan',604800,NULL);
INSERT INTO relic VALUES('Masters4',0.75,'Hood of the Master Scholar','Grants permanent academic prestige!',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('Doctoral1',0.5,'Annotated Tome of Wisdom','Literature reviews are insightful!',100,'Soldier',1,NULL);
INSERT INTO relic VALUES('Doctoral2',0.5,'Philosopher’s Quill','Writing becomes a breeze!',2,'Soldier',604800,NULL);
INSERT INTO relic VALUES('Doctoral3',0.5,'Academic Amulet','Defense presentation is a breeze!',2,'Artisan',604800,NULL);
INSERT INTO relic VALUES('Doctoral4',0.75,'Doctoral Robes of Power','Grants permanent academic prestige!',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('Sage1',0.5,'Philosopher’s Patronage','All future grants amaze the reviewers!',100,'Soldier',1,NULL);
INSERT INTO relic VALUES('Sage2',0.5,'Ivory Quill of the Ages','Publishing is a breeze!',2,'Soldier',604800,NULL);
INSERT INTO relic VALUES('Sage3',0.5,'Chair’s Scepter','Committee meetings now take 50% less energy!',2,'Artisan',604800,NULL);
INSERT INTO relic VALUES('Sage4',0.75,'Sigil of Eternal Knowledge','Ensures lasting academic legacy!',100,'Artisan',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Ever-Full Flask ðŸ¥¤','Thy cup shall never run dry! Thou dost remember to hydrate more frequently!',10,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Cozy Cloak of Softness ðŸ§£','Thy sensory needs are met! Thou dost gain comfort & warmth bonuses for deep relaxation.',50,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Windborne Muse ðŸ’¨','Inspiration strikes!',100,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Weighted Blanket of Tranquility ðŸ›','Thine anxieties are eased! Thou shalt fall asleep more swiftly and rest more deeply.',100,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Arcane Spice Rack ðŸŒ¿','Thy meals taste superior!',50,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Enchanted Candle of Focus ðŸ•¯','Boosts concentration & ambiance!',50,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Lavender Satchel of Peace ðŸŒ¸','Repels stress! Thou dost gain a resistance against distractions & sensory overload!',100,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Satchel of Perpetual Order ðŸŽ’','Reduces clutter! Next organizational task takes half the effort.',100,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Starlit Headphones ðŸŽ§','Protects thee from auditory distractions! Focus tasks are less likely to be interrupted!',20,'healer',1,NULL);
INSERT INTO relic VALUES('healerRnd',0.3,'Cozy Cocoon Socks ðŸ§¦','Feet are warm, mind is at peace! Sitting still during study sessions becomes twice as easy.',20,'healer',1,NULL);
