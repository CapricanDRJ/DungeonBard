...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS "relic" ("id" TEXT, "chance" TEXT, "name" TEXT, "description" TEXT, "bonusXp" TEXT, "profession" TEXT, "duration" TEXT, "iconURL" TEXT);
